...
cons:
  [
    ...
    "Physical edition is expensive especially if you live outside of the USA",
  ]
...
![Start of dungeon exploration after setup](./iron_dungeon_1.jpg)
_Start of dungeon exploration after setup_
...
![Available player characters in the base game](./iron_characters.jpg)
_Available player characters in the base game_
...
![Tracking cards at the beginning of the game](./iron_tracker_sheet_early.jpg)
_Tracking cards at the beginning of the game_
...
![Two facedown dungeon cards two choose from](./iron_dungeon_down.jpg)
_Two facedown dungeon cards two choose from_
...
_Flipping the first dungeon card_
...
![Flipping and selecting the second dungeon card option](./iron_dungeon_up_2.jpg)
_Flipping and selecting the second dungeon card option_
...
![Combat with a two health zombie that has an extra health due to ambush card adding the dungeon level as health](./iron_zombie_health.jpg)
_Combat with a two health zombie that has an extra health due to ambush card adding the dungeon level as health_
...
![Example of a plot card that provides the chance to heal and gamble, while also providing two plot points](./iron_plot_example.jpg)
_Example of a plot card that provides the chance to heal and gamble, while also providing two plot points_
...
_Example of a morality impacting plot card_
...
![Example of a blessing token with a generic blessing side and an extra health on the other](./iron_blessing.jpg)
_Example of a blessing token with a generic blessing side and an extra health on the other_
...
![Stacks of each enemy type I killed during this dungeon](./iron_count_enemies.jpg)
_Stacks of each enemy type I killed during this dungeon_
...
![Lich boss which was triggered due to the most defeated enemy type being undead](./iron_boss.jpg)
_Lich boss which was triggered due to the most defeated enemy type being undead_
...
_Lich boss with low health and dealing 9 damage to the player_
...
_New cards in the Loot and Lore pack_
...
_New cards in the Howling Abyss Dungeon Deck_
