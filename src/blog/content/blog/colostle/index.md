...
I bought the digital version of Colostle from the [official store](https://www.colostle.com/product-page/colostle-digital-content-pack) for £8.
...
![Colostle playing cards](./colostle_cards.jpg)
_Colostle playing cards_
...
![Official art showing the setting and characters representing each class](./colostle_art.jpg)
_Official art showing the setting and characters representing each class_
...
![Character sheet with their example of how a journal entry might look](./colostle_character_sheet.png)
_Character sheet with their example of how a journal entry might look_
...
![Exploration table example](./colostle_table.png)
_Exploration table example_
...
![Example of how a exploration phase card draw might look like](./colostle_explore.jpg)
_Example of how a exploration phase card draw might look like_

Combat is fairly simple, which may put off players expecting more complex and challenging combat. First you create the opponent which might be another person or a rook, these each have their own smaller tables to generate how they fight. Enemies will draw a certain number of cards based on their strength and size then you draw cards based on your combat score. Next you need to play one of your cards to counter the next card the enemy plays, this is ideally of a higher card value to win that combat. If you lose combat you take a wound against your exploration or combat score. You continue to fight until the opponent has used all of their cards.
...
![Example of a combat encounter against a medium rook as a character with four combat score, they would win but take a wound in the process](./colostle_combat.jpg)
_Example of a combat encounter against a medium rook as a character with four combat score, they would win but take a wound in the process_
...
![Example of an item available from a merchant](./colostle_items.png)
_Example of an item available from a merchant_
...
![Official photo of a spread of the Roomlands Expansion describing a new biome](./colostle_roomlands.jpg)
_Official photo of a spread of the Roomlands Expansion describing a new biome_
...
![Official photo of the job decks](./colostle_jobs.jpg)
_Official photo of the job decks_
